...
#: The instruction bank lives once, under scripts/sweep/pinned/, where
#: MANIFEST.sha256 holds it still because the perf ratchet compares against it.
#: benchmark/instruction_bank/ used to be a second copy of the same
#: instructions.jsonl; it is gone, and this reads the pinned one, which the
#: tests read too.
_BANK = _HERE.parent / 'scripts' / 'sweep' / 'pinned'
