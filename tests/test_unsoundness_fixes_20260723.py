...
_CASES = [
    ...
    ('ARM64', '3f0c02eb', {'x1': 0x7123AD969C24A699, 'x2': 0x3C3F2B2EE39A0502},
     {'x2': 0x1200000000000000}, 'cmp x1,x2,lsl #3 NG sign-flag shifted-operand wrap'),
    ('ARM64', '200802ab', {'x1': 0x123456789ABCDEF, 'x2': 0x2000000000000000},
     {'x2': 0x2000000000000000}, 'adds x0,x1,x2,lsl #2 NG sign-flag shifted-operand wrap'),
