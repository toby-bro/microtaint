...
class TestShadowMemory:
    ...
    def test_write_mask_8bytes(self, benchmark: Any, shadow: BitPreciseShadowMemory) -> None:
    ...
    def test_write_mask_1byte(self, benchmark: Any, shadow: BitPreciseShadowMemory) -> None:
    ...
    def test_write_mask_clear_8bytes(self, benchmark: Any, shadow: BitPreciseShadowMemory) -> None:
    ...
    def test_read_mask_8bytes_tainted(self, benchmark: Any, shadow: BitPreciseShadowMemory) -> None:
    ...
    def test_read_mask_8bytes_clean(self, benchmark: Any, shadow: BitPreciseShadowMemory) -> None:
        """read_mask on a clean (zero-taint) region — early-exit path."""
        shadow.write_mask(0x5000, 0, 8)
        benchmark(shadow.read_mask, 0x5000, 8)

    def test_read_mask_8bytes_cold(self, benchmark: Any, shadow: BitPreciseShadowMemory) -> None:
    ...
    def test_is_tainted_true(self, benchmark: Any, shadow: BitPreciseShadowMemory) -> None:
    ...
    def test_is_tainted_false(self, benchmark: Any, shadow: BitPreciseShadowMemory) -> None:
    ...
    def test_is_poisoned_false(self, benchmark: Any, shadow: BitPreciseShadowMemory) -> None:
        """is_poisoned on non-freed memory — fires on every mem read in UAF mode."""
        benchmark(shadow.is_poisoned, 0x8000, 8)

    def test_is_poisoned_true(self, benchmark: Any, shadow: BitPreciseShadowMemory) -> None:
        """is_poisoned on freed memory — the detection hit case."""
        shadow.poison(0x9000, 64)
        benchmark(shadow.is_poisoned, 0x9000, 8)

    def test_write_bytes_8(self, benchmark: Any, shadow: BitPreciseShadowMemory) -> None:
    ...
    def test_cross_page_write(self, benchmark: Any, shadow: BitPreciseShadowMemory) -> None:
...
class TestSimulator:
    ...
    def test_setup_regs_2(self, benchmark: Any, amd64_sim: CellSimulator) -> None:
    ...
    def test_setup_regs_6(self, benchmark: Any, amd64_sim: CellSimulator) -> None:
    ...
    def test_setup_regs_18(self, benchmark: Any, amd64_sim: CellSimulator) -> None:
    ...
    def test_execute_same_bytes_twice(self, benchmark: Any, amd64_sim: CellSimulator) -> None:
        """
    ...
    def test_execute_different_bytes(self, benchmark: Any, amd64_sim: CellSimulator) -> None:
        """
    ...
    def test_differential_2regs(self, benchmark: Any, amd64_sim: CellSimulator) -> None:
    ...
    def test_differential_18regs(self, benchmark: Any, amd64_sim: CellSimulator) -> None:
    ...
    def test_differential_with_memory(self, benchmark: Any, amd64_sim: CellSimulator) -> None:
    ...
    def test_differential_arm64_2regs(self, benchmark: Any, arm64_sim: CellSimulator) -> None:
...
class TestWrapperPrimitives:
    ...
    def test_address_check_single_range_hit(self, benchmark: Any) -> None:
        """
    ...
    def test_address_check_single_range_miss(self, benchmark: Any) -> None:
    ...
    def test_address_check_list_any_hit(self, benchmark: Any) -> None:
        """
    ...
    def test_read_18_keys_from_dict(self, benchmark: Any) -> None:
        """
    ...
    def test_read_23_keys_from_dict(self, benchmark: Any) -> None:
        """
    ...
    def test_eflags_unpack_bitshift(self, benchmark: Any) -> None:
        """
    ...
    def test_shallow_copy_dict_small(self, benchmark: Any) -> None:
        """
    ...
    def test_shallow_copy_dict_large(self, benchmark: Any) -> None:
        """
