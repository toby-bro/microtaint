...
class TestRoundTrip:
    ...
    def test_single_bit_round_trip_per_byte_position(self, shadow: BitPreciseShadowMemory) -> None:
        """
    ...
    def test_zero_mask_clears(self, shadow: BitPreciseShadowMemory) -> None:
...
class TestPageBoundary:
    ...
    def test_taint_spanning_page_boundary(self, shadow: BitPreciseShadowMemory) -> None:
        """
    ...
    def test_high_address_far_from_zero(self, shadow: BitPreciseShadowMemory) -> None:
    ...
    def test_two_distant_addresses_independent(self, shadow: BitPreciseShadowMemory) -> None:
...
class TestIsTainted:
    def test_untainted_returns_false(self, shadow: BitPreciseShadowMemory) -> None:
        assert not shadow.is_tainted(0x1000, 8)

    def test_any_byte_tainted_returns_true(self, shadow: BitPreciseShadowMemory) -> None:
    ...
    def test_partial_overlap_with_tainted_region(self, shadow: BitPreciseShadowMemory) -> None:
...
class TestClear:
    ...
    def test_clear_only_affects_specified_range(self, shadow: BitPreciseShadowMemory) -> None:
...
class TestWriteBytesReadBytes:
    def test_write_bytes_round_trip(self, shadow: BitPreciseShadowMemory) -> None:
        addr = 0x1000
    ...
    def test_write_bytes_zero_clears(self, shadow: BitPreciseShadowMemory) -> None:
        shadow.write_mask(0x1000, 0xFFFFFFFFFFFFFFFF, 8)
...
class TestPoisonIsolation:
    ...
    def test_unpoison_clears_poison_only(self, shadow: BitPreciseShadowMemory) -> None:
    ...
    def test_is_poisoned_default_false(self, shadow: BitPreciseShadowMemory) -> None:
