...
class TestMemoryLoadAST:
    ...
    def test_load_qword_ast(self, x86_64_registers) -> None:
    ...
    def test_load_dword_ast(self, x86_64_registers) -> None:
    ...
    def test_load_word_ast(self, x86_64_registers) -> None:
    ...
    def test_load_byte_ast(self, x86_64_registers) -> None:
...
class TestMemoryStoreAST:
    ...
    def test_store_qword_ast(self, x86_64_registers) -> None:
    ...
    def test_store_dword_ast(self, x86_64_registers) -> None:
    ...
    def test_store_word_ast(self, x86_64_registers) -> None:
    ...
    def test_store_byte_ast(self, x86_64_registers) -> None:
...
class TestMemoryToMemoryAST:
    ...
    def test_memory_copy_chain(self, x86_64_registers) -> None:
...
class TestMemoryReadModifyWriteAST:
    ...
    def test_add_to_memory_ast(self, x86_64_registers) -> None:
    ...
    def test_inc_memory_ast(self, x86_64_registers) -> None:
    ...
    def test_xor_memory_ast(self, x86_64_registers) -> None:
        """xor [rdi], eax - RMW XOR."""
        arch = Architecture.AMD64
        # xor [rdi], eax -> 31 07
...
class TestMemoryOperandStructure:
    ...
    def test_memory_operand_has_address_expr(self, x86_64_registers) -> None:
    ...
    def test_memory_operand_has_size(self, x86_64_registers) -> None:
    ...
    def test_different_sizes_have_correct_operands(self, x86_64_registers) -> None:
